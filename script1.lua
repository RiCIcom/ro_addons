...
local function openRemoteSpy()
    local spyFrame = EasyUI:Frame(screenGui, UDim2.new(0.7, 0, 0.7, 0), UDim2.new(0.15, 0, 0.15, 0), Color3.fromRGB(25, 25, 25))
    EasyUI:UICorner(spyFrame, UDim.new(0, 20))
    EasyUI:ApplyShadow(spyFrame)

    local spyHeader = EasyUI:TextButton(spyFrame, "Generated by RiCIs Scripts - Remote Spy", UDim2.new(1, -20, 0, 50), UDim2.new(0, 10, 0, 10), Color3.fromRGB(30, 30, 30))
    spyHeader.TextColor3 = Color3.fromRGB(230, 230, 230)
    spyHeader.TextSize = 22
    ...
    local listFrame = EasyUI:ScrollingFrame(spyFrame, UDim2.new(0.3, -20, 0.75, -20), UDim2.new(0, 10, 0.25, 10), UDim2.new(0, 0, 2, 0))
    EasyUI:UICorner(listFrame, UDim.new(0, 10))
    EasyUI:UIStroke(listFrame, 2, Color3.fromRGB(0, 0, 0))
    EasyUI:UIListLayout(listFrame, 10)

    local editorFrame = EasyUI:Frame(spyFrame, UDim2.new(0.65, -20, 0.75, -20), UDim2.new(0.35, 10, 0.25, 10), Color3.fromRGB(40, 40, 40))
    EasyUI:UICorner(editorFrame, UDim.new(0, 15))
    EasyUI:UIStroke(editorFrame, 3, Color3.fromRGB(0, 0, 0))

    local editorLabel = EasyUI:TextLabel(editorFrame, "Editor", UDim2.new(1, -20, 0, 50), UDim2.new(0, 10, 0, 10), Color3.fromRGB(180, 180, 180), 24)
    ...
    local editorContent = EasyUI:ScrollingFrame(editorFrame, UDim2.new(1, -20, 0.85, -60), UDim2.new(0, 10, 0, 60), UDim2.new(0, 0, 2, 0))
    EasyUI:UIStroke(editorContent, 2, Color3.fromRGB(255, 255, 255))
    local editorText = EasyUI:TextLabel(editorContent, "Wähle ein Remote Event aus, um Details zu sehen", UDim2.new(1, -10, 0, 1000), UDim2.new(0, 5, 0, 5), Color3.fromRGB(60, 60, 60), 18)
    ...
    editorText.TextColor3 = Color3.fromRGB(230, 230, 230)
...
local function startLoadingScreen()
    ...
    local headerLabel = EasyUI:TextLabel(loadingFrame, "Scripted by RICi", UDim2.new(1, -20, 0, 50), UDim2.new(0, 10, 0, 10), Color3.fromRGB(230, 230, 230), 22)
